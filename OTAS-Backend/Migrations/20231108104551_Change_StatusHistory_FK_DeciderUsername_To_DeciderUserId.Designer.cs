...
namespace OTAS.Migrations
{
    ...
    [Migration("20231108104551_Change_StatusHistory_FK_DeciderUsername_To_DeciderUserId")]
    partial class Change_StatusHistory_FK_DeciderUsername_To_DeciderUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OTAS.Models.ActualRequester", b =>
                {
                    ...
                    b.HasOne("OTAS.Models.User", "BehalfUser")
                        .WithMany("ActualRequesters")
                        .HasForeignKey("BehalfUserId")
                        .IsRequired()
                        .HasConstraintName("FK_BehalfUser");
